...
public class UserInfo {
	...
	private void putExperience(Map<String, String> params) {
		for (Experience exp : experience) {
			...
			params.put("previous_companies[]",sb.toString());
		}

	}

	private void putEducation(Map<String, String> params) {
		...
		for (Education ed : education) {
			...
			params.put("education[]", sb.toString());
		}
	}
	 ...
	 * @param params
	 */
	private void putIfSet(String key, String value, Map<String, String> params) {
		if (value != null) {
